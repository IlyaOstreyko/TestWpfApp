...
{
    public class TestQuestionVM : INotifyPropertyChanged
    {
        [Required, Key]
        ...
        private byte[]? imageQuestionBytes { get; set; }
        ...
        private int numberInList { get; set; }
        public bool HasImage =>
    ImageQuestionBytes != null &&
    ImageQuestionBytes.Length > 0;
        public byte[] ImageQuestionBytes
        {
            get { return imageQuestionBytes; }
            set
            {
                imageQuestionBytes = value;
                OnPropertyChanged("ImageQuestionBytes");
            }
        }
        ...
        public int NumberInList
        {
            ...
            {
                numberInList = value;
                OnPropertyChanged("NumberInList");
            }
        }

        public void RefreshImage()
        {
            if (ImageQuestionBytes == null || ImageQuestionBytes.Length == 0)
            {
                FullImageQuestion = null;
                return;
            }

            using var ms = new MemoryStream(ImageQuestionBytes);
